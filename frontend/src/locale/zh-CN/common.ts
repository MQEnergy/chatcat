export default {
  ...
  'common.prompt.select.title3': '改写:',
  'common.prompt.select.title3.desc': '重写以下内容:',
  'common.prompt.select.title4': '润色:',
  'common.prompt.select.title4.desc': '将以下内容进行润色:',
  'common.prompt.select.title5': '总结:',
  'common.prompt.select.title5.desc': '将一下内容进行归纳总结:',
  'common.prompt.select.title6': '解释:',
  'common.prompt.select.title6.desc': '解释以下内容:',
  'common.prompt.select.title7': '解释代码:',
  'common.prompt.select.title7.desc': '解释以下代码:',
};