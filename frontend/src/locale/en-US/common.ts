export default {
  ...
  'common.chat.limit': 'Supports up to 100 chats at most',
  'common.chat.nopre': 'There is no user conversation above, please enter again',
  ...
  'common.prompt.input.replyform': 'reply with markdown form format',
  ...
  'common.prompt.select.title5.desc': 'Please provide the content that needs to be translated and polished:',
  'common.prompt.select.title6': 'Summary:',
  'common.prompt.select.title6.desc': 'Summarize the following content:',
  'common.prompt.select.title7': 'Explain:',
  'common.prompt.select.title7.desc': 'Explain the following content:',
  'common.prompt.select.title8': 'Explain Codes:',
  'common.prompt.select.title8.desc': 'Explain the following codes:',
};