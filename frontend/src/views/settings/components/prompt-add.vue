  ...
  <a-modal v-model:visible="props.visible"
    ...
    <a-form ref="formRef" :model="form" layout="vertical">
      ...
      <a-form-item field="prompt" :label="$t('settings.prompt.cate.prompt')"
                   ...
                   :validate-trigger="['change','input']">
        <a-textarea v-model="form.prompt" :placeholder="$t('settings.prompt.cate.prompt.placeholder')" allow-clear/>
      </a-form-item>
      <a-form-item field="enprompt" :label="$t('settings.prompt.cate.enprompt')">
        <a-textarea v-model="form.enprompt" :placeholder="$t('settings.prompt.cate.enprompt.placeholder')" allow-clear/>
      </a-form-item>
...
watch(() => props.formData, () => {
  if (props.formData) {
    ...
    form.prompt = props.formData.prompt;
    form.enprompt = props.formData.enprompt;
  } else {
